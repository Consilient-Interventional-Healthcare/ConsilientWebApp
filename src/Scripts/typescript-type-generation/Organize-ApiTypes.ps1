...
function ConvertTo-NamespacedTypeScript {
    param(
        [string]$Content,
    ...
    # Expand mapping for referenced types so enums/deps move with their users
...
try {
    ...
    # Organize content
    $result = ConvertTo-NamespacedTypeScript -Content $content -InterfaceMapping $mapping
