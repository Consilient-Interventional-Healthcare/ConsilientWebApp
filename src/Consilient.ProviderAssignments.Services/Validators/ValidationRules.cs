namespace Consilient.ProviderAssignments.Services.Validators
{
    ...
    public static class ValidationRules
    {
        ...
        /// </summary>
        public static string? ValidateDateNotFuture(DateOnly? date, string fieldName, DateOnly today)
        {
        ...
        /// </summary>
        public static List<string> ValidateDateFields(DateTime admit, DateOnly? dob, DateTime now)
        {
            var errors = new List<string>();
            ...
            var dobError = ValidateDateNotFuture(dob, "Date of birth", DateOnly.FromDateTime(now));
            if (dobError != null)
            {
                errors.Add(dobError);
            }
