...
namespace Consilient.ProviderAssignments.Services.Cache
{
    ...
    public class ProviderAssignmentResolutionCache
    {
        ...
        public ProviderAssignmentResolutionCache(ConsilientDbContext dbContext)
        {
